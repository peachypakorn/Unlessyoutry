    ...
    <div class ="content" style = "background:white">
        ...
        <div id = "slideshow-container" style = "background-color:black');">
            <div class="mySlides move">
                <!-- <img src="../img/act-com/bigbubble-act/ex1.png" id = "ex1"> -->
                <img src="../img/act-com/bigbubble-act/pic1.jpg" style="width:100%">
            </div>
            <div class="mySlides move">
                <img src="../img/act-com/bigbubble-act/pic2.jpg" style="width:100%">
            </div>
            <div class="mySlides move">
                <img src="../img/act-com/bigbubble-act/pic3.jpg" style="width:100%">
            </div>
            <div class="mySlides move">
                <img src="../img/act-com/bigbubble-act/pic4.jpg" style="width:100%">
            </div>
            <div class="mySlides move">
                <img src="../img/act-com/bigbubble-act/pic5.jpg" style="width:100%">
            </div>
        ...
        <img src="../img/act-com/bigbubble-act/text1.png" id = "text1">
        <br><br><br>
        <div class = "sd"> 
        ...
        <br><br>
        <img src="../img/act-com/bigbubble-act/text2.png" id = "text2-c" class ="">
    </div>
    ...
    <script>
     $("html, body").animate({ scrollTop: 0 }, "slow");
        ...
        function showSlides(n,b,t) {
          ...
          // $("#slideshow-container").css({"background-image":" url('../img/act-com/bigbubble-act/ex1.png');"});
          ...
          if(b==1)document.getElementById("slideshow-container").style.backgroundImage = "url('../img/act-com/bigbubble-act/pic1.jpg')";
          if(b==2)document.getElementById("slideshow-container").style.backgroundImage = "url('../img/act-com/bigbubble-act/pic2.jpg')";
          if(b==3)document.getElementById("slideshow-container").style.backgroundImage = "url('../img/act-com/bigbubble-act/pic3.jpg')";
          if(b==4)document.getElementById("slideshow-container").style.backgroundImage = "url('../img/act-com/bigbubble-act/pic4.jpg')";
          if(b==5)document.getElementById("slideshow-container").style.backgroundImage = "url('../img/act-com/bigbubble-act/pic5.jpg')";
          var send = slideIndex;
