...
<body>
    <div class = "left-banner">
        <div class = "wrap">
          <img id="ibanner" src="../img/act-com/colorrun-act/banner.jpg" alt="phum-banner">
          ...
          <img id="twoline-topic" src="../img/act-com/colorrun-act/Topic.png" alt="colorrun">
          <p  class = "twoline-date">05.01.2016</p>
          <p  class = "twoline-place">BANGKOK</p>
          <a class = "p pointer" href ="http://thecolorrun.com/" target="_blank">
          ...
          <a class = "p pointer" href ="http://thecolorrun.com/events/" target="_blank">
    ...
    <div class ="content" style = "background:white">
        ...
        <div id = "slideshow-container" style = "background-color:black');">
            ...
            <div class="mySlides move ">
                <video loop poster controls style="width:100%" id="story-vid" >
                    <source src="../img/act-com/colorrun-act/video.mp4" type= "video/mp4">
                </video>
            </div>
            <div class="mySlides move">
                <img src="../img/act-com/colorrun-act/pic3.jpg" style="width:100%">
            </div>
            <div class="mySlides move">
        ...
        <img src="../img/act-com/colorrun-act/text1.png" id = "text1">
        <br><br><br>
        <div class = "sd"> 
