...
<body>
    <div class = "left-banner">
        <div class = "wrap">
          <img id="ibanner" src="../img/story-com/phum-story/banner.jpg" alt="phum-banner">
    ...
    <div class ="content" style = "background:white">
        ...
        <div id = "slideshow-container" style = "background-color:black');">
            <div class="mySlides move">
                <img src="../img/story-com/phum-story/ex1.png" id = "ex1">
            ...
            <div class="mySlides move">
                <img src="../img/story-com/phum-story/pic4.jpg" style="width:100%">
            </div>
        ...
        <img src="../img/story-com/phum-story/text1.png" id = "text1">
        <br><br><br>
        <div class = "sd"> 
        ...
        <br><br>
        <img src="../img/story-com/phum-story/text2.png" id = "text2" class ="">
    </div>
    <script>
     $("html, body").animate({ scrollTop: 0 }, "slow");
        ...
        function showSlides(n,b,t) {
          ...
          if(b==4)document.getElementById("slideshow-container").style.backgroundImage = "url('../img/story-com/phum-story/pic4.jpg')";
          var send = slideIndex;
