...
<body>
    <div class = "left-banner">
        <div class = "wrap">
          <img id="ibannerh" style = "left:-35%" src="../img/story-com/touch-story/banner.jpg" alt="phum-banner">
    ...
    <div class ="content" style = "background:white">
        ...
        <div id = "slideshow-container" style = "background-color:black');">
            <div class="mySlides move">
                <!-- <img src="../img/story-com/touch-story/ex1.png" id = "ex1"> -->
                <img src="../img/story-com/touch-story/pic1.jpg" style="width:100%">
            </div>
            <div class="mySlides move ">
                <video loop poster controls style="width:100%;height:48%" id="story-vid" >
                    <source src="../img/story-com/touch-story/video.mp4" type= "video/mp4">
                </video>
            </div>
            <div class="mySlides move">
                <img src="../img/story-com/touch-story/pic3.jpg" style="width:100%">
            </div>
            <div class="mySlides move">
                <img src="../img/story-com/touch-story/pic4.jpg" style="width:100%">
            </div>
            <div class="mySlides move">
                <img src="../img/story-com/touch-story/pic5.jpg" style="width:100%">
            </div>
        ...
        <img src="../img/story-com/touch-story/text1.png" id = "text1">
        <br><br><br>
        <div class = "sd"> 
        ...
        <br><br>
        <img src="../img/story-com/touch-story/text2.png" id = "text2-c" class ="">
    </div>
    <script>
     $("html, body").animate({ scrollTop: 0 }, "slow");
        ...
        function showSlides(n,b,t) {
          ...
          // $("#slideshow-container").css({"background-image":" url('../img/story-com/touch-story/ex1.png');"});
          ...
          if(b==1)document.getElementById("slideshow-container").style.backgroundImage = "url('../img/story-com/touch-story/pic1.jpg')";
          if(b==2)document.getElementById("slideshow-container").style.backgroundImage = "url('../img/story-com/touch-story/pic2.png')";
          if(b==3)document.getElementById("slideshow-container").style.backgroundImage = "url('../img/story-com/touch-story/pic3.jpg')";
          if(b==4)document.getElementById("slideshow-container").style.backgroundImage = "url('../img/story-com/touch-story/pic4.jpg')";
          if(b==5)document.getElementById("slideshow-container").style.backgroundImage = "url('../img/story-com/touch-story/pic5.jpg')";
          var send = slideIndex;
